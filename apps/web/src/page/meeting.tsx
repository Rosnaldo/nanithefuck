...
export default function HomePage() {
    return (
        <div className="h-screen flex flex-col">
            <main className="relative flex-1 overflow-y-auto no-scrollbar bg-[#f0ede6]">
                <Header />
                <section className="relative w-full h-[20vh]">
                    
                </section>

                <section id="picnique" className="relative w-full h-[40vh]">
                    <div className="md:w-auto md:max-w-[420px] w-4/5 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-10">
                        <img
                ...
                <section id="bottom" className="relative w-full h-[100vh]">
                    <BottomBgSvg />
                </section>
