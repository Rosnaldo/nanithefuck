...
import { type Participant, type ParticipantStatus, type User } from "@/lib/types"
...
interface MeetingParticipantsProps {
  ...
  onChangeStatus: (userId: string, status: ParticipantStatus) => void
}
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3">
        ...
        <Select
          value={statusFilter}
          onValueChange={(v) => setStatusFilter(v as "all" | ParticipantStatus)}
        >
